 ...
 * Create the map
 */
var map = AmCharts.makeChart("animated_chart", {
    "type": "map",
    "theme": "light",
...
var map = AmCharts.makeChart("curved_chart", {
    "type": "map",
    "theme": "none",
    "dataProvider": {
        "map": "worldLow",
    ...
    "imagesSettings": {
        "color": "#4327B7",
        "rollOverColor": "#4327B7",
        "selectedColor": "#4327B7"
    },
...
/* ------------- map amchart 3 start ------------ */
var map = AmCharts.makeChart("zoom_country_chart", {
...
/* ------------- map amchart 4 start ------------ */
var map = AmCharts.makeChart("pattern_map", {
 ...
 * Create a map
 */
var map = AmCharts.makeChart("pie_map", {
    "type": "map",
    "theme": "light",
    "projection": "winkel3",
