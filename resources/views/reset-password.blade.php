...
<head>
    ...
    *===========================-->
    ...
    <!--=========================*
              Page Title
    *===========================-->
    <title>Reset Password | Devmix Bootstrap 4 Admin Template</title>
...
<!-- login area start -->
<div class="lock-screen" style="background: url('{{asset('assets/images/bg-img.jpg')}}');">
    <div class="login-form credentials-form">
        <form>
            ...
            <div class="login-form-body">
                ...
                <div class="form-gp">
                    <label for="exampleInputPassword2">Reset Password</label>
