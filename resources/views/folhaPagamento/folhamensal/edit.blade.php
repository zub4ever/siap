...
@section('page-title') Editar @endsection
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route("folhamensal.index")}}">Folha</a></li>
    <li class="breadcrumb-item active"><a>Editar Folha</a></li>
</ol>
...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card_title">Editar</h4>
                <form action="{{route('folhamensal.update', $folhapgto->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    @include('folhaPagamento.folhamensal.form-edit')
                </form>
            </div>
        </div>
    </div>
