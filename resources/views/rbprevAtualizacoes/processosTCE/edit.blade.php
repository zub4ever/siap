...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route("folhamensal.index")}}">RBPREV NÚMEROS</a></li>
    <li class="breadcrumb-item active"><a>Editar RBPREV NÚMEROS</a></li>
</ol>
    ...
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('folhamensal.update', $rbprevnumeros->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    @include('rbprevAtualizacoes.rbprevNumeros.form-edit')
                </form>
            </div>
        </div>
    </div>
