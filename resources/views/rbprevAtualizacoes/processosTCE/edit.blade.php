...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route("processosTCE.index")}}">Processos Homologados</a></li>
    <li class="breadcrumb-item active"><a>Editar Processos Homologados</a></li>
</ol>
...
<script src="{{asset('js/processosTCE/create.js')}}"></script>
@endsection
