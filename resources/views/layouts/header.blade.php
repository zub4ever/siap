                        ...
                        <li class="dropdown">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton"
                                    ...
                                    <span class="d_none_sm"> <font color="#6600ff">{{Auth::user()->name}} </font><i
                                            class="ti-angle-down"></i></span>

                                </button>
                                <a href="/logout"> <img width="20" height="10" src="{{asset('assets/images/sair.png')}}"
                                                        alt="" class="img-fluid"></a>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="/logout"><font color="#ff0000"><i
                                                class="ti-power-off"></i>Logout</a> </font>
                                </div>
                            </div>
                        </li>
                    </div>
