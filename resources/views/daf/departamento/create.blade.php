...
@section('page-title') Cadastrar Departamento @endsection
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><a>Cadastrar departamento</a></li>
</ol>
...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card_title">Cadastrar departamento</h4>
                <form action="{{route('departamento.store')}}" method="POST">
                    @csrf
                    @include('daf.departamento.form')
                </form>
            </div>
        </div>
    </div>
