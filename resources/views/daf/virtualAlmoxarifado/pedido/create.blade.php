...
@section('page-title') Pedido @endsection
...
<script src="{{asset('js/almoxarifado/AlmoxarifadoVirtual/pedido/create.js')}}">
</script><script src="{{asset('js/almoxarifado/AlmoxarifadoVirtual/pedido/novo.js')}}"></script>
<script src="{{asset('js/almoxarifado/AlmoxarifadoVirtual/pedido/selectdois.js')}}"></script>
