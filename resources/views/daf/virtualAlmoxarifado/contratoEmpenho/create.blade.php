...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route("ContratoEmpenho.index")}}">Contratos</a></li>
    <li class="breadcrumb-item active"><a>Cadastrar Contreatos</a></li>
</ol>
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('ContratoEmpenho.store')}}" method="POST">
                    @csrf
                    @include('daf.virtualAlmoxarifado.contratoEmpenho.form')
                </form>
            </div>
        </div>
    </div>
...
<script src="{{asset('js/almoxarifado/AlmoxarifadoVirtual/create.js')}}"></script>
@endsection
