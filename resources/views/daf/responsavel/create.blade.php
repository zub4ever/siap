...
@section('page-title') Cadastrar Responsavel @endsection
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route("responsavel.index")}}">Responsavel</a></li>
    <li class="breadcrumb-item active"><a>Cadastrar responsavel</a></li>
</ol>
...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card_title">Cadastrar responsavel</h4>
