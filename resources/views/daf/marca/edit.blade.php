...
@section('page-title') Editar Marca @endsection
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><a>Editar Marca</a></li>
</ol>
...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card_title">Editar Marca</h4>
                <form action="{{route('marca.update', $marca->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    @include('daf.marca.form')
                </form>
            </div>
        </div>
    </div>
