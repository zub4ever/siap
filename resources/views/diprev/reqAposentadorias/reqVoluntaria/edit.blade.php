...
@section('page-title') Editar item @endsection
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route("reqVoluntaria.index")}}">Requerimento Voluntário</a></li>
    <li class="breadcrumb-item active"><a>Editar Requerimento</a></li>
</ol>
...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card_title">Editar Requerimento Voluntário</h4>
                <form action="{{route('reqVoluntaria.update', $reqApVoluntaria->id)}}" method="POST">
                    @csrf
                    @method('PUT')
