...
@section('page-title') Requerimento @endsection
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><a>Visualizar Requerimento</a></li>
</ol>
...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card_title"> Requerimento</h4>
                
                    
                    @include('diprev.reqAposentadorias.reqVoluntaria.form-show')
