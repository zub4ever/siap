...
@section('page-title') Editação do Beneficiário @endsection

@section('main-content')
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route("home")}}">Início</a></li>
        <li class="breadcrumb-item"><a href="{{route("beneficiario.index")}}">Beneficiário</a></li>
        <li class="breadcrumb-item active"><a>Editar beneficiário</a></li>
    </ol>
    ...
    <div class="row">
        <div class="col-lg-12 mb-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Editar Beneficiário</h4>
...
@section('js')
    ...
    <script src="{{asset('js/beneficiario/create.js')}}"></script>
