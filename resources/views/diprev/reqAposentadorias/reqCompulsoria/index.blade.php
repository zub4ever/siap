...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><a>Ap C</a></li>
</ol>
...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-body">
                <a class="btn btn-success btn-md" data-toggle="tooltip" data-placement="right" title="Cadastrar novo" href="{{route('reqCompulsoria.create')}}" role="button">
                    Novo requerimento
                </a>
...
<div class="row">
    <div class="col-12 mb-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card_title">Requerimentos Ap C</h4>
